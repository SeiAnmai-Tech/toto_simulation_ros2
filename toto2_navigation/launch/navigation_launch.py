...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument('params_file', default_value=os.path.join(bringup_dir, 'params', 'toto2_nav2_params.yaml'), description='Full path to the ROS2 parameters file to use for all launched nodes')
    declare_mask_yaml_file_cmd = DeclareLaunchArgument('mask', default_value=os.path.join(bringup_dir, 'maps', 'preffed_lanes.yaml'), description='Full path to filter mask yaml file to load')
    ...
    declare_container_name_cmd = DeclareLaunchArgument('container_name', default_value='nav2_container', description='the name of container that nodes will load in if use composition')
