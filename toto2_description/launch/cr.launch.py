...
def generate_launch_description():
    ...
    clear_costmaps_service = LaunchConfiguration('clear_costmaps_service')
    ...
    declare_clear_costmaps_cmd = DeclareLaunchArgument('clear_costmaps_service', default_value='/local_costmap/clear', description='Full path to the Clear Costmaps service')
    ...
    ld.add_action(declare_clear_costmaps_cmd)

    # Add actions in the desired order
    ld.add_action(execute_keep_out_script_cmd)  # Start keep_out.py to wait for user points
